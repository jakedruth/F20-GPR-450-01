...
// const
a3_SpatialPose * a3spatialPostOpConst(a3_SpatialPose * pose_inout);
...
a3_HierarchyPose* a3hierarchyPoseOpIdentity(a3_HierarchyPose* pose_out, a3size const numNodes);

// pointer-based LERP operation for hierarchical pose
a3_HierarchyPose* a3hierarchyPoseOpLERP(a3_HierarchyPose* pose_out, a3size const numNodes, a3_HierarchyPose const* pose0, a3_HierarchyPose const* pose1, a3real const u);
